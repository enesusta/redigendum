 ...
 * @author Enes
 */
public class Redigendum extends javax.swing.JFrame {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(Redigendum.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Redigendum().setVisible(true);
			}
		});
	}
	...
	public void action() {
		...
		Start.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				JOptionPane.showMessageDialog(null, "giriyor");
				executeCommand(link);
			}
		});
	...
	public void executeCommand(String link) {
      ...
      //  arguments.add("/bin/bash");
        ...
        arguments.add("-/c");
//        arguments.add("youtube-dl -x -o '~/Desktop/playlist/%(title)s.%(ext)s' "+youtube);
...
//        arguments.add("avconv -i source.mp4 -s 1920x1080 output.mp4");
	...
	String file = System.getProperty("user.home")+File.separator+"Desktop"+File.separator+"deneme.txt";
		...
		Input2.setCaretPosition(Input2.getDocument().getLength());
			...
			Logger.getLogger(Redigendum.class.getName()).log(Level.SEVERE, null, ex);
